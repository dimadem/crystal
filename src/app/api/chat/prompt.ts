...
export const createPrompt = (message: string) => spaceTrim((block) => `

    You are an expert on mindmaps and have been asked to create a specific mindmap for a user
    The user has requested a mindmap with the following structure:
    ...
    Formatting:
    - Write only the text within the quotes.
